...
public class ConnUtil {
     ...
     */
    public static String getResponseString(HttpURLConnection conn) throws IOException, ConnException {
     ...
     * @throws ConnException http 的状态码不是 200
     */
    public static byte[] getResponseBytes(HttpURLConnection conn) throws IOException, ConnException {
        ...
        if (responseCode != 200) {
            ...
            throw new ConnException("http response code is" + responseCode);
        }
